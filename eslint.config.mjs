...
const eslintConfig = defineConfig([
  ...
  // `lib/api/schema.ts` is codegen output (openapi-typescript) and all four
  // `lib/map/*.generated.ts` files are generator output (generate:map, which emits BOTH
  // the interactive and the mini Türkiye artifacts / generate:world-map / generate:water)
  // — machine-written, never hand-edited, so none
  ...
  globalIgnores([
    ...
    "lib/map/tr-provinces-mini.generated.ts",

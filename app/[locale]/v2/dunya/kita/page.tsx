...
export default async function V2ContinentsHubPage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    { name: "Dünya Atlası", path: "/v2/dunya" },
    { name: "Kıtalar Atlası", path: "/v2/dunya/kita" },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
            ...
            <div className="space-y-3 max-w-3xl">
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                ...
                tektonik oluşumu, makroklima kuşakları, büyük nehir havzaları ve demografik
                yapıları. İstatistiklerin ardındaki coğrafi mekanizmaları keşfedin.
              </p>
            </div>
            ...
            <div className="space-y-4 max-w-4xl">
              ...
              <div className="text-sm text-muted-foreground space-y-3 leading-relaxed">
                ...
                <p>
                  ...
                  yaklaşımı kullanır. Olimpiyat halkaları ise insanın kalıcı olarak yaşadığı 5
                  kıtayı (Antarktika hariç, Amerika tek) simgeler.
                </p>

                <p>
                  <strong>Sınırlar Birer Doğal Eşik midir, Yoksa Sözleşme mi?</strong> Afrika ile
                  Asya arasında Süveyş Kıstağı, Kuzey ve Güney Amerika arasında Panama Kıstağı
                  fiziki boğaz ve kıstak sınırları oluşturur. Ancak <strong>Avrupa ile Asya</strong>{" "}
                  arasındaki sınır bütünüyle tarihsel bir konvansiyondur: İki kıta tektonik olarak
                  tek parça olan Avrasya levhasında oturur. 18. yüzyıldan itibaren Rus ve Avrupalı
                  coğrafyacıların uzlaşısıyla Ural Dağları, Ural Nehri ve Kafkaslar sınır kabul
                  edilmiştir.
                </p>
              </div>
            </div>

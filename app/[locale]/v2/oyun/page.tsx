...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: "Dilsiz harita üzerinde Türkiye illerini ve coğrafi bölgelerini bularak harita hafızanızı geliştirin.",
    alternates: {
      canonical: "/v2/oyun",
    },
  };
      ...
      <JsonLd
        schema={[
          learningResourceJsonLd({
            ...
            description: "Dilsiz Türkiye haritası üzerinde illeri ve coğrafi bölgeleri interaktif olarak keşfedin.",
            path: "/v2/oyun",
            locale,
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-b from-card via-card to-muted/30 p-6 sm:p-10 shadow-lg">
            <div className="relative z-10 max-w-3xl space-y-4">
              ...
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
                Dilsiz Türkiye haritası üzerinde illeri doğru bularak puan toplayın, bölge bazlı sınavlara katılın ve mekânsal hafızanızı en üst seviyeye çıkarın.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-8">
              <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
                <span className="font-heading text-2xl sm:text-3xl font-bold text-primary block">3 Oyun</span>
                <span className="text-xs text-muted-foreground font-medium">Farklı Sınav &amp; Test Modu</span>
              </div>
              <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
                <span className="font-heading text-2xl sm:text-3xl font-bold text-secondary block">81 İl</span>
                <span className="text-xs text-muted-foreground font-medium">Eksiksiz Soru Havuzu</span>
              </div>
              <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
                <span className="font-heading text-2xl sm:text-3xl font-bold text-accent block">7 Bölge</span>
                <span className="text-xs text-muted-foreground font-medium">Bölgesel Harita Tamamlama</span>
              </div>
              <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
                <span className="font-heading text-2xl sm:text-3xl font-bold text-[var(--color-primary-dark,#7e3a1e)] block">%100</span>
                <span className="text-xs text-muted-foreground font-medium">Gerçek Zamanlı Geri Bildirim</span>
              </div>
            </div>
          </div>
        </div>

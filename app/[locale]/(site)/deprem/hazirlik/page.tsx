    ...
    <>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-b from-card via-card to-muted/30 p-6 sm:p-10 shadow-lg">
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
              Deprem anında panik yerine doğru refleksi sergileyebilmek için bilimsel, pedagojik ve
              uygulanabilir adımlar. Sarsıntı öncesinde yaşam alanını güvenli kılma, sarsıntı
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-8">
            ...
            <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
              ...
              <span className="text-xs text-muted-foreground font-medium">Çök – Kapan – Tutun</span>
            </div>
            <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
              <span className="font-heading text-2xl sm:text-3xl font-bold text-primary block">
                112
      ...
      <div className="p-6 sm:p-8 rounded-3xl border border-primary/40 bg-gradient-to-br from-primary/5 via-card to-card space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
          ...
          <div className="p-4 rounded-2xl bg-card border border-border space-y-1">
            <span className="font-bold text-foreground text-sm block">e-Devlet Toplanma Alanı</span>
            <p className="text-muted-foreground">

        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-b from-card via-card to-muted/30 p-6 sm:p-10 shadow-lg">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-8">
            <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
              ...
              <span className="text-xs text-muted-foreground font-medium">KAF Toplam Uzunluk</span>
            </div>
            <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
              <span className="font-heading text-2xl sm:text-3xl font-bold text-blue-600 block">
                550 km
              </span>
              <span className="text-xs text-muted-foreground font-medium">DAF Toplam Uzunluk</span>
            </div>
            <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
            ...
            <div className="p-4 rounded-2xl bg-card border border-border shadow-2xs">
              ...
              <span className="text-xs text-muted-foreground font-medium">Batıya Doğru Kaçış</span>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <tbody className="divide-y divide-border/60">
                    {fault.historicalEarthquakes.map((eq, i) => (
                      <tr key={i} className="hover:bg-muted/20 transition-colors">
                        ...
                        <td className="p-3 font-mono font-bold text-destructive">{eq.magnitude}</td>
            ...
            {fault.marineConnection && (
              <div className="p-4 rounded-2xl border border-cyan-500/30 bg-cyan-500/5 text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex items-center gap-2 text-cyan-800 dark:text-cyan-300">
                  ...
                  <span>
                    <strong>Denizaltı Fayı Bağlantısı:</strong> {fault.marineConnection.description}
                  </span>
                </div>
                <Link
                  href={

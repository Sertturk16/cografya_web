 ...
 * `app/[locale]/(site)/not-found.tsx` INSIDE V1 header and footer: a not-found boundary replaces
 ...
 * recorded limitation `app/[locale]/(site)/not-found.tsx` documents — `not-found.tsx` receives no
